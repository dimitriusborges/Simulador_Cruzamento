...
class Semaforo:
    ...
    def add_horizontal(self, master: Canvas, x, y, verde=False, amarelo=False, vermelho=False):
        ...
        semaforos.append(master.create_oval(x, y, x + 25, y + 25, fill=cor_vermelho, tag=self.tag + '_vm', width=largura_vm))
        semaforos.append(master.create_oval(x - 25, y, x, y + 25, fill=cor_amarelo, tag=self.tag + '_am', width=largura_am))
        semaforos.append(master.create_oval(x - 50, y, x + 25 - 50, y + 25, fill=cor_verde, tag=self.tag + '_vd', width = largura_vd))
    ...
    def add_vertical(self, master: Canvas, x, y, verde=False, amarelo=False, vermelho=False):
        ...
        semaforos.append(master.create_oval(x, y, x + 25, y + 25, fill=cor_vermelho, tag=self.tag + '_vm', width=largura_vm))
        semaforos.append(master.create_oval(x, y + 25, x + 25, y + 25 + 25, fill=cor_amarelo, tag=self.tag + '_am', width=largura_am))
        semaforos.append(master.create_oval(x, y + 50, x + 25, y + 25 + 50, fill=cor_verde, tag=self.tag + '_vd', width=largura_vd))
